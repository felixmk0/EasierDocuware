...
namespace EasierDocuware.Services.Public
{
    public class DocumentService : IDocumentService
    {
        ...
        public Task<ServiceResult<bool>> UpdateDocFieldsAsync(Document doc, List<DocumentIndexField> fields, bool forceUpdate) => _internal.UpdateDocFieldsAsync(doc, fields, forceUpdate);
        public Task<ServiceResult<bool>> BatchUpdateDocFieldsAsync(string fileCabinetId, List<int> documentIds, List<DocumentIndexField> fields, bool forceUpdate) => _internal.BatchUpdateDocFieldsAsync(fileCabinetId, documentIds, fields, forceUpdate);
        ...
        public Task<ServiceResult<bool>> CreateDocAsync(string fileCabinetId, List<DocumentIndexField> fields) => _internal.CreateDocAsync(fileCabinetId, fields);
    }
}
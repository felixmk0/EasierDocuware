...
namespace EasierDocuware.Services.Internal
{
    public class DocumentService : IDocumentService
    {
        ...
        public Task<ServiceResult<bool>> ForceUpdateBatchAppendKeywordIndexFields(string fileCabinetId, List<int> documentIds, string keywordsFieldName, List<string> keywordValues, string storeDialogId, bool forceUpdate)
        {
            return _documentServiceInternal.ForceUpdateBatchAppendKeywordIndexFields(fileCabinetId, documentIds, keywordsFieldName, keywordValues, storeDialogId, forceUpdate);
        }

...
namespace EasierDocuware.Interfaces.Internal
{
    ...
    {
        Task<ServiceResult<bool>> BatchUpdateDocFieldsAsync(string fileCabinetId, List<int> documentIds, List<DocumentIndexField> fields, bool forceUpdate);
        ...
        Task<ServiceResult<bool>> CreateDocAsync(string fileCabinetId, List<DocumentIndexField> fields);
        ...
        Task<ServiceResult<bool>> UpdateDocFieldsAsync(Document doc, List<DocumentIndexField> fields, bool forceUpdate);
